...
| 18 | Security guardrails enforced by middleware + route metadata + tests, not convention | 3–11 | RouteMeta permission gate; `make test-security`; per-knob unsafe-config matrix |
