...
# Deviations record — W04-E04-S001
...
obvious, e.g. the exact `hash_version` value chosen or the metadata-canonicalization approach
selected) is recorded here, not folded silently into `story.md` or `plan.md`.*
