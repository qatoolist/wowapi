...
|---|---|---|---|---|---|---|---|---|
| [W02-E02-S002-T001](task-001-mismatch-audit.md) | Mismatch audit (DATA-01 T3) | unassigned | implemented | none (soft: more useful after W02-E02-S001-T002's scanner confirms the 8-edge inventory) | Zero-mismatch report against staging/prod-shaped data, or a documented remediation-decision record | AC-W02-E02-S002-01 | complete | executed (2026-07-16) |
| [W02-E02-S002-T002](task-002-composite-fk-notvalid.md) | Composite FK `NOT VALID` add, all 8 edges (DATA-01 T4) | unassigned | implemented | T001; **hard gate: W02-E01-S001 and W02-E01-S002 both `accepted`** | 8 per-table `NOT VALID` composite FK adds | AC-W02-E02-S002-02 | complete | executed (2026-07-16) |
| [W02-E02-S002-T003](task-003-validate-constraint.md) | `VALIDATE CONSTRAINT` each new composite FK (DATA-01 T5) | unassigned | implemented | T002; **hard gate: W02-E01-S001 and W02-E01-S002 both `accepted`** | 8 validated composite FKs; second zero-mismatch confirmation | AC-W02-E02-S002-03 | complete | executed (2026-07-16) |
| [W02-E02-S002-T004](task-004-cross-tenant-negative-tests.md) | Seeded cross-tenant insert negative tests, both roles (DATA-01 T7) | unassigned | done | T003 | Catalog-driven RLS matrix test, cross-tenant insert fails under `app_rt` and `app_platform` | AC-W02-E02-S002-04 | complete | executed (2026-07-16) |
| [W02-E02-S002-T005](task-005-redundant-fk-cleanup.md) | Optional redundant single-column FK cleanup (DATA-01 T8) | unassigned | done | T003, T004 | FK-removal migration + consumer/rollback verification record, or explicit deferral | AC-W02-E02-S002-05 | complete | executed (2026-07-16) |
| [W02-E02-S002-T006](task-006-independent-review.md) | Independent review | unassigned | done | T001, T002, T003, T004, T005 | Review report confirming the W02-E01 gate was honored and the mismatch-audit outcome honestly recorded | AC-W02-E02-S002-01, AC-W02-E02-S002-02, AC-W02-E02-S002-03, AC-W02-E02-S002-04, AC-W02-E02-S002-05 | complete | executed (2026-07-16) |
