...
process-not-code). P1: **CA-8/11/13/14/15 CLOSED** (CA-11 all but a small anchor-export); **CA-9** (async
trace propagation) and **CA-12** O2/O5 remain OPEN, **CA-10** is a recorded deployment-concern rescope —
all low-risk and documented above. Net: **all P0 *code* corrective actions are closed and gated**; the
