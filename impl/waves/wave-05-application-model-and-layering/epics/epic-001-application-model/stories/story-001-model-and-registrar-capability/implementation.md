...
# Implementation record — W05-E01-S001
...
*Not applicable — this story adds Go types only; no schema or migration change (see `story.md`
"Migration considerations").*

## Security changes

*Not yet implemented — the `Registrar` capability type's seal-method boundary is the security
change this story exists to make; recorded here once implemented.*
