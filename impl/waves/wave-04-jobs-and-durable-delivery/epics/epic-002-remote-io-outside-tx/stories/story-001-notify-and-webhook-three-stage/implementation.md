...
# Implementation record — W04-E02-S001
...
*Not yet implemented — a claim-row schema migration adding shared-primitive lease columns to
notify/webhook's delivery-tracking tables is planned (see `plan.md`), not yet executed.*
